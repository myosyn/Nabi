...
package gradle.kotlin.dsl.plugins._dbf9b3adad15d5fbd386cf57fa88cbc2
...
/**
 * The `kotlinx-atomicfu` plugin implemented by [kotlinx.atomicfu.plugin.gradle.AtomicFUGradlePlugin].
 */
internal
val `PluginDependenciesSpec`.`kotlinx-atomicfu`: PluginDependencySpec
    get() = this.id("kotlinx-atomicfu")
