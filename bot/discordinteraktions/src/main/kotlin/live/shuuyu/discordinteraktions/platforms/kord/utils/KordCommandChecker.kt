    ...
    fun checkAndExecute(request: DiscordInteraction, requestManager: RequestManager) {
        ...
        when (applicationCommandType) {
            ...
            ApplicationCommandType.ChatInput -> {
                ...
                val command =
                    CommandDeclarationUtils.getApplicationCommandDeclarationFromLabel<SlashCommandDeclaration>(
                        interactionsManager,
                        commandLabels
                    )
                        ?: return
            ...
            ApplicationCommandType.User -> {
                val command = CommandDeclarationUtils.getApplicationCommandDeclarationFromLabel<UserCommandDeclaration>(
                    interactionsManager,
                    commandLabels
                )
                    ?: return
            ...
            ApplicationCommandType.Message -> {
                val command =
                    CommandDeclarationUtils.getApplicationCommandDeclarationFromLabel<MessageCommandDeclaration>(
                        interactionsManager,
                        commandLabels
                    )
                        ?: return
