...
open class BarebonesInteractionContext(
    ...
    suspend fun sendModal(declaration: ModalExecutorDeclaration, title: String, builder: ModalBuilder.() -> (Unit)) =
        sendModal(declaration.id, title, builder)
    ...
    ) = sendModal(declaration.id, data, title, builder)

    suspend fun sendModal(id: String, data: String, title: String, builder: ModalBuilder.() -> (Unit)) =
        sendModal("$id:$data", title, builder)
