package live.shuuyu.discordinteraktions.platforms.kord.commands
...
object CommandDeclarationUtils {
     ...
     */
    fun getLabelsConnectedToCommandDeclaration(
     ...
     * @return the matched declaration
     */
    private fun getLabelsConnectedToSlashCommandDeclaration(
        labels: List<CommandLabel>,
