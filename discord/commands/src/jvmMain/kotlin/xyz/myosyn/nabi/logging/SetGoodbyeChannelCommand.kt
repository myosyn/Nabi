...
import xyz.myosyn.nabi.logging.SetModerationLoggingChannelCommand.Companion.Options.register

class SetGoodbyeChannelCommand(val restClient: RestClient) : ApplicationCommandOptions() {
